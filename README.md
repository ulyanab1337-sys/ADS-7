...
**по 31.05.2026** ![Relative date](https://img.shields.io/date/1780261200)
...
Модифицировать код функции **main.cpp** для проведения вычислительного эксперимента. Необходимо построить график:

Зависимость числа операций от длины поезда **n**
   - если все лампочки выключены
   - если все лампочки включены
   - если распределение включенных/выключенных лампочек случайное


Построить графики с линиями тренда и сохранить в файле **plot.png**
...
Файл **result/plot.png** содержит результаты вычислительного эксперимента. 

## Полезные ссылки (могут не работать :(
